...
export const systemhealth = props => {
	...
	return (
		<svg data-name="Layer 1" viewBox="0 0 266 266" width={size || width} height={size || height} className={styles}>
			<path
...
export const Connectivity = props => {
	...
	return (
		<svg width={size || width} height={size || height} className={styles} viewBox="0 0 611.989 611.988">
			<path
				fill={props.fill || 'currentColor'}
				{...rest}
...
export const Performance = props => {
	...
	return (
		<svg width={size || width} height={size || height} className={styles} viewBox="0 0 18 18">
			<path fill={props.fill || 'currentColor'} {...rest} d="M1.803 14.85V1.389H.146v15.222h17.708V14.85z" />
			<path
				fill={props.fill || 'currentColor'}
				{...rest}
